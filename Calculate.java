...
/**
 ...
 Подключение класса необходимо при необходимости выполнения операций возведения в степнь, вычисления корня и т.д.
*/
...
/**
 		...
 		Деление через создание объектов
*/
...
/**
 	...
 	Операции возведения в степень, вычисления корня требует импорта класса java.lang.Math.*
*/
	System.out.println("abs= "+Math.abs(-2.33));
	System.out.println("stupen= "+Math.pow(par1,par2));		// par1 -число, par2 - степень
	System.out.println("sqrt= "+Math.sqrt(par2));
/**
 Дія піднесення до ступеня вимагає для результату типу даних double
 Операция возведения в степень требует для результата типа данных double
*/
